...
<body>
	...
	<form class="container" action="write.do" method="post">
		<h2>글 쓰기</h2>
		<br>
		<div class="form-inline">
			<label for="exampleFormControlInput2">작성자 : </label>&nbsp;&nbsp;&nbsp;<input name="writer" class="form-control" id="exampleFormControlInput2" value="${login.id}" readonly="readonly">
		</div>
		<div class="form-inline"> 
			...
			</select><br> <br> &nbsp;&nbsp;&nbsp; <label for="exampleFormControlInput1">제목 : </label>&nbsp;&nbsp;&nbsp;
			<input name="title" type="text" class="form-control col-9" id="exampleFormControlInput1" width="200px" required="required">
		</div>
